        ...
        <header class="p-3">
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    <a href="https://redminton.cloud" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
                    ...
                    <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search">
                        <input type="search" class="form-control form-control-dark text-start" placeholder="Pesquisar..." aria-label="Search">
                    </form>
                    <div class="text-end">
                        <button onclick="window.location.href='login.html'" type="button" class="btn btn-warning">MinhaConta</button>
                    </div>
                </div>
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
...
<head>
    ...
    <link href="https://crystalmissoes.pages.dev/css/cssindex.css" rel="stylesheet">
...
<body>
    <div class="container">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="carousel slide" id="carousel-249885">
                        ...
                        </div> <a class="carousel-control-prev" href="#carousel-249885" data-slide="prev"><span
                                class="carousel-control-prev-icon"></span> <span class="sr-only">Anterior </span></a> <a
                            class="carousel-control-next" href="#carousel-249885" data-slide="next"><span
                                class="carousel-control-next-icon"></span> <span class="sr-only">Próxima</span></a>
                    </div>
                </div>
            </div>
        </div>
