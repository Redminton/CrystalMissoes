    ...
    async fetch(request, env, ctx) {
        ...
        if (url.pathname.startsWith('/produtos/')) {
            ...
            try {
                ...
                html += '<li><a href="https://redminton.cloud" class="nav-link px-2 text-secondary">Início</a></li>';
                ...
                html += '</ul>';
                html += '<form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search">';
                html += '<input type="search" class="form-control form-control-dark text-start" placeholder="Pesquisar..." aria-label="Search"></form>';
                ...
                html += '<li class="nav-item"><a class="nav-link text-white" href="#">Gargantilhas</a></li>';
                html += '<li class="nav-item"><a class="nav-link text-white" href="#">Pulseiras</a></li>';
                html += '<li class="nav-item"><a class="nav-link text-white" href="#">Conjuntos</a></li>';
                html += '<li class="nav-item"><a class="nav-link text-white" href="#">Acessórios</a></li>';
                html += '<li class="nav-item"><a class="nav-link text-white" href="#">Masculinos</a></li>';
                html += '</ul></div></div></header>';
